...
public class Cliente {
    ...
    @NotNull(message = "El tipo de documento es obligatorio") @ManyToOne @JoinColumn(name = "id_tipo_documento", nullable = false) private TipoDocumento tipoDocumento;
    @NotBlank(message = "El número de documento no puede ir vacío") @Column(nullable = false, unique = true, length = 50) private String numeroDocumento;
